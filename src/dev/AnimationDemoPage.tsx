    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <ScrollReveal>
        <section className="mb-16">
          <h2 className="text-2xl font-heading font-bold mb-6 text-teal-dark">Page Transitions</h2>
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            <div className="text-center">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <p className="text-xl text-teal font-heading">Page Content</p>
              </motion.div>
            </div>
          </div>
        </section>
      ...
      <ScrollReveal delay={0.2}>
        <section className="mb-16">
          <h2 className="text-2xl font-heading font-bold mb-6 text-teal-dark">Enhanced Buttons</h2>
          <p className="mb-4 text-gray-700">
      ...
      <ScrollReveal delay={0.3} variant="fadeLeft">
        <section className="mb-16">
          <h2 className="text-2xl font-heading font-bold mb-6 text-teal-dark">Micro-interactions</h2>
          <p className="mb-4 text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center justify-center space-x-4">
                <motion.button
                  className="w-12 h-12 bg-teal text-white rounded-full flex items-center justify-center"
                ...
                <motion.div
                  ...
                  className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center text-2xl font-bold text-teal"
                >
                  {count}
                </motion.div>
                <motion.button
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  className="bg-teal-extralight p-4 rounded-lg flex items-center justify-center cursor-pointer"
                  whileHover={{ 
                    scale: 1.05,
                ...
                <motion.div
                  className="bg-sage-extralight p-4 rounded-lg flex items-center justify-center cursor-pointer"
                  whileHover={{ 
                    y: -5,
                ...
                <motion.div
                  className="bg-terracotta-extralight p-4 rounded-lg flex items-center justify-center cursor-pointer"
                  whileHover={{ rotate: 5 }}
                  transition={{ duration: 0.2 }}
                >
                  Rotate Effect
                ...
                <motion.div
                  className="border-2 border-teal p-4 rounded-lg flex items-center justify-center cursor-pointer"
                  whileHover={{ 
                    scale: 1.05,
                    borderWidth: "4px",
                    margin: "-2px"
      ...
      <ScrollReveal variant="stagger" staggerChildren={0.1}>
        <section className="mb-16">
          <h2 className="text-2xl font-heading font-bold mb-6 text-teal-dark">Scroll Animations</h2>
          <p className="mb-4 text-gray-700">
      ...
      <ScrollReveal variant="fadeUp">
        <section className="text-center">
          <h2 className="text-2xl font-heading font-bold mb-6 text-teal-dark">Enhanced User Experience</h2>
